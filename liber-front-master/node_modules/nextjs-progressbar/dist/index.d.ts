...
declare function NextNProgress({ color, startPosition, stopDelayMs, height, showOnShallow, options, nonce, }: {
    /**
...
declare namespace NextNProgress {
    var propTypes: {
...
export { NextNProgress as default };
