class GetOnlineBooksModel {
  GetOnlineBooksModel({this.count, this.next, this.previous, this.results});
  ...
  factory GetOnlineBooksModel.fromJson(Map<String, dynamic> json) =>
      GetOnlineBooksModel(
        count: json["count"],
        next: json["next"],
